...
| TB2     | 01/07/2026 | Paredes Santos, Fabrizio Alberto | Desarrollo de los puntos  8.3.4.2, 8.3.4.1, 8.3.4., 6.3.3, 6.3.2, 6.3.1 y 6.3.             |
| TB2     | 01/07/2026 | Bueno Perales Mathias Eduardo | Desarrollo de los puntos 7.4, 7.4.1, 7.4.2, 7.4.3 y 7.4.             |
| TB2     | 01/07/2026 | Rios Pacheco Hector Javier | Desarrollo de los puntos 8.3.1. , 8.3.2. , 8.3.3. , 7.3. y 8.4.             |
| TB2     | 02/07/2026 | Rodriguez Macedo Sebatian | Apoyo en las secciones 8.3.4 To-Be Validation Interviews, 8.4 Experiment Aftermath & Analysis, 8.5 Continuous Learning y Conclusiones.             |
| TB2     | 06/07/2026 | Awad Vargas Giorgio Marzouk | Apoyo en seccion 8.3 y elaboracion de presentacion final             |
...
| Sebastian Rodriguez Macedo| `Shiftinnnnn` | Desarrollo del Capitulo VI |
...
| Integrante                      | Usuario Github | Detalle de avance                                                                                                                                                                                                                                                                                                            |
| ------------------------------- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fabrizio Alberto Paredes Santos | `psfa29`       |  Desarrollo de los puntos  8.3.4.2, 8.3.4.1, 8.3.4., 6.3.3, 6.3.2, 6.3.1 y 6.3.                                                                                                                                                                                                                                                                          |
| Mathias Eduardo Bueno Perales   | `MathiasBueno` | Desarrollo de los puntos 7.4, 7.4.1, 7.4.2, 7.4.3 y 7.4.4                                                                   |
| Sebastian Rodriguez Macedo      | `Shiftinnnnn`  | Apoyo en las secciones 8.3.4 To-Be Validation Interviews, 8.4 Experiment Aftermath & Analysis, 8.5 Continuous Learning y Conclusiones.                                                                                                                                                                  |
| Giorgio Marzouk Awad Vargas     | `GiorgioAwad`  |       Apoyo en seccion 8.3 y elaboracion de presentacion final                                                                                                                                                            |
| Hector Javier Rios Pacheco      | `Khafna09`     | Desarrollo de los puntos 8.3.1., 8.3.2. , 8.3.3. , 7.3. y 8.4. |
...
- [Capítulo VIII: Experiment-Driven Development](#capítulo-viii-experiment-driven-development)
  ...
  - [8.3. Experimentation](#83-experimentation)
    ...
    - [8.3.3. Pipeline-supported, Experiment-Driven To-Be Software Platform Lifecycle](#833-pipeline-supported-experiment-driven-to-be-software-platform-lifecycle)
     ...
     -  [8.3.3.3. Implemented To-Be Frontend-Web Application Evidence](#8332-implemented-to-be-frontend-web-application-evidence)
...
|                                                                                                                                                              | Awad Vargas, Giorgio Marzouk     | TP1        | Elaboración de mockups móviles, revisión de flujos de interacción y corrección de errores de consistencia visual y funcional en el diseño del producto, relacionado con las secciones 4.4.3 Mobile Applications Mock-ups y 4.5 Mobile Applications Prototyping. | La revisión responsable de los mockups y prototipos permitió reducir ambigüedades antes de la implementación, mejorar la comprensión de los flujos de usuario y prevenir errores que podrían afectar la experiencia de empresarios y distribuidores en escenarios reales de uso.                                                                                                                                                                                                |
|                                                                                                                                                              | Rodríguez Macedo, Sebastián      | TP1        | Elaboración de mockups móviles, revisión de flujos de interacción y corrección de errores de consistencia visual y funcional en el diseño del producto, relacionado con las secciones 4.4.3 Mobile Applications Mock-ups y 4.5 Mobile Applications Prototyping. | La validación y corrección de las pantallas propuestas evidencia responsabilidad profesional al asegurar que la solución diseñada sea comprensible, usable y coherente con las necesidades operativas descritas en el análisis de usuarios y en los requerimientos del producto.                                                                                                                                                                                                  |
...
|                                                                                                                                                              | Rios Pacheco, Hector Javier      | AV2        | Identificación y documentación de supuestos, brechas de conocimiento e hipótesis críticas a través de un backlog de preguntas y tarjetas de experimentación (Experiment Cards) basadas en el estado actual del sistema (As-Is).                     | Mitigar la incertidumbre técnica mediante el diseño de experimentos rigurosos refleja un compromiso ético y profesional, asegurando que el desarrollo de software se fundamente en evidencia validada y transparente, protegiendo los recursos de la organización y la confianza del usuario final.                                                                                                                                                                             |
|                                                                                                                                                              | Awad Vargas, Giorgio Marzouk     | AV2        | Desarrollo de la aplicación móvil nativa, implementación de pantallas para los roles Empresario y Distribuidor, registro de evidencias visuales y aplicación de mejoras continuas, relacionado con las secciones 5.2.1 Sprint Backlogs y 5.2.5 Implemented Native-Mobile Application Evidence. | La implementación móvil y sus mejoras continuas demuestran responsabilidad profesional al convertir los diseños validados en funcionalidades operativas, procurando que el producto entregue evidencia clara, reduzca errores de registro y mantenga coherencia con los objetivos de trazabilidad de TextilFlow.                                                                                                                                                                |
|                                                                                                                                                              | Rodríguez Macedo, Sebastián      | AV2        | Desarrollo de la aplicación móvil nativa, implementación de pantallas para los roles Empresario y Distribuidor, registro de evidencias visuales y aplicación de mejoras continuas, relacionado con las secciones 5.2.1 Sprint Backlogs y 5.2.5 Implemented Native-Mobile Application Evidence. | La construcción y mejora iterativa de la aplicación móvil evidencia compromiso ético con la calidad del software, ya que permite entregar una herramienta más estable y alineada con las necesidades de documentación, control y transparencia de los usuarios del sector textil.                                                                                                                                         |
|                                                                                                                                                              | Bueno Perales, Mathias Eduardo   | TB2        | Implementar un pipeline de monitoreo continuo con Prometheus y Grafana que permita recolectar, almacenar, visualizar y alertar métricas en tiempo real de la aplicación TextilFlow, garantizando transparencia operativa y capacidad de respuesta ante anomalías.             | La implementación del pipeline de monitoreo continuo en TextilFlow refleja un ejercicio de responsabilidad ética y profesional en ingeniería de software. Al garantizar la observabilidad, la detección temprana de fallos y la comunicación efectiva mediante alertas y notificaciones, se asegura la calidad, confiabilidad y sostenibilidad del sistema. Estas prácticas promueven la transparencia frente al equipo y los usuarios, fortaleciendo la confianza en el producto y demostrando compromiso con estándares profesionales que priorizan la seguridad, la eficiencia y el bienestar de las partes interesadas.                                               |
|                                                                                                                                                              | Paredes Santos, Fabrizio Alberto | TB2        | Desarrollo de las secciones 6.3 Validation Interviews, 6.3.1 Diseño de Entrevistas, 6.3.2 Registro de Entrevistas, 6.3.3 Evaluaciones según heurísticas, 8.3.4 To-Be Validation Interviews, 8.3.4.1 Diseño de Entrevistas y 8.3.4.2 Registro de Entrevistas, validando la solución con usuarios y revisando aspectos de usabilidad.    | Las entrevistas y evaluaciones permitieron actuar con responsabilidad profesional al comprobar si TextilFlow era claro, útil y comprensible para los usuarios antes de asumir su aceptación.                                            |
|                                                                                                                                                              | Rios Pacheco, Hector Javier      | TB2        | Implementación del núcleo de seguimiento de experimentos (Controller, Service) e integración de botones de eventos de clicks en vistas clave (Registro de Lote, Observaciones, Configuración, Dashboard) para la recolección de telemetría de uso. | La integración estructurada del código de seguimiento experimental demuestra responsabilidad profesional al asegurar que la plataforma recopile telemetría técnica y de uso en entornos locales y de pruebas de manera controlada y transparente. |
|                                                                                                                                                              | Rodríguez Macedo, Sebastián      | TB2        | Apoyo en la documentación y revisión de las secciones 8.3.4 To-Be Validation Interviews, 8.4 Experiment Aftermath & Analysis, 8.5 Continuous Learning y Conclusiones, consolidando evidencias de validación, análisis posterior del experimento y aprendizajes del equipo. | El apoyo en estas secciones evidencia responsabilidad profesional al asegurar que los resultados de la experimentación se presenten de forma clara, coherente y sustentada en evidencia, permitiendo comunicar los hallazgos y aprendizajes de TextilFlow con transparencia. |
| Awad Vargas, Giorgio Marzouk      | TB2        | Apoyo en el desarrollo de la sección 8.3 Experimentation, contribuyendo a la documentación de los To-Be User Stories, To-Be Product Backlog y Sprint Backlogs correspondientes, así como en la elaboración de la presentación final del proyecto. | La participación en la documentación de la experimentación y en la presentación final evidencia responsabilidad profesional al asegurar que los resultados del proceso de desarrollo sean comunicados de forma clara, ordenada y sustentada, cumpliendo con los estándares de entrega del equipo. |
...
|                                                                                                                                                              | Awad Vargas, Giorgio Marzouk     | TP1        | Análisis de necesidades de uso móvil y elaboración de mockups para validar visualmente los flujos principales del producto, vinculados con las secciones 4.4 Mobile Applications UX/UI Design, 4.4.3 Mobile Applications Mock-ups y 4.4.4 Mobile Applications User Flow Diagrams. | La elaboración de mockups permitió emitir juicios informados sobre cómo la experiencia móvil impacta en la adopción de la solución, especialmente en talleres y distribuidores que requieren registrar información con rapidez para reducir errores operativos y pérdidas económicas.                                                                                                                                                                                              |
|                                                                                                                                                              | Rodríguez Macedo, Sebastián      | TP1        | Análisis de necesidades de uso móvil y elaboración de mockups para validar visualmente los flujos principales del producto, vinculados con las secciones 4.4 Mobile Applications UX/UI Design, 4.4.3 Mobile Applications Mock-ups y 4.4.4 Mobile Applications User Flow Diagrams. | La participación en los mockups y correcciones de diseño permitió evaluar el impacto social y económico de una interfaz clara, accesible y orientada a usuarios que necesitan documentar incidencias textiles sin aumentar la carga operativa del proceso.                                                                                                                                                                                                                         |
...
|                                                                                                                                                              | Rios Pacheco, Hector Javier      | AV2        | Estructuración del diseño experimental y formulación de hipótesis para validar la viabilidad técnica y operativa de la solución, partiendo de la evaluación del contexto actual del negocio.                                                        | La formulación de hipótesis y el diseño de experimentos permiten emitir juicios informados sobre la viabilidad de la solución de software, evaluando su impacto socioeconómico antes de la fase de construcción para evitar sobrecostos y asegurar que el producto aporte un valor real en su contexto de despliegue.                                                                                                                                                           |
|                                                                                                                                                              | Awad Vargas, Giorgio Marzouk     | AV2        | Desarrollo de la aplicación móvil nativa, corrección de errores detectados durante la implementación y aplicación de mejoras continuas sobre las pantallas documentadas en la sección 5.2.5 Implemented Native-Mobile Application Evidence.          | La implementación y mejora de la app móvil permitió tomar decisiones informadas sobre usabilidad, registro de evidencia y soporte a los roles del sistema, considerando el impacto económico de reducir reprocesos y el impacto social de mejorar la transparencia entre empresarios y distribuidores.                                                                                                                                                                           |
|                                                                                                                                                              | Rodríguez Macedo, Sebastián      | AV2        | Desarrollo de la aplicación móvil nativa, corrección de errores detectados durante la implementación y aplicación de mejoras continuas sobre las pantallas documentadas en la sección 5.2.5 Implemented Native-Mobile Application Evidence.          | Las mejoras continuas realizadas en la aplicación móvil permitieron ajustar la solución a escenarios reales de operación, favoreciendo una experiencia más clara, reduciendo posibles errores de registro y fortaleciendo el valor de TextilFlow como herramienta de trazabilidad colaborativa.                                                                                                                                                                                   |
|                                                                                                                                                              | Bueno Perales, Mathias Eduardo   | TB2        | Implementar un pipeline de monitoreo continuo con Prometheus y Grafana que permita recolectar, almacenar, visualizar y alertar métricas en tiempo real de la aplicación TextilFlow, garantizando transparencia operativa y capacidad de respuesta ante anomalías.             | La implementación del pipeline de monitoreo continuo en TextilFlow representa un juicio informado que considera los impactos de la ingeniería de software en distintos contextos globales, económicos, ambientales y sociales. Al utilizar herramientas abiertas y ampliamente adoptadas como Prometheus y Grafana, se fomenta la interoperabilidad y la colaboración internacional, lo que fortalece la sostenibilidad tecnológica en un entorno global.                                               |
|                                                                                                                                                              | Paredes Santos, Fabrizio Alberto | TB2        | Validación de funcionalidades como el Certificado de Pre-Despacho Digital, Catálogo Visual de Defectos, modo offline, sincronización por WiFi, código de barras y dashboard de auditoría, considerando su impacto en trazabilidad, reclamos y eficiencia operativa.    | El trabajo permitió tomar decisiones informadas sobre cómo TextilFlow puede reducir conflictos, mejorar el control de calidad y generar mayor confianza entre empresas textiles y distribuidores.                                     |
|                                                                                                                                                              | Rios Pacheco, Hector Javier      | TB2        | Monitoreo de interacción del usuario mediante endpoints de tracking, y depuración y corrección del entorno de base de datos local y puertos (reparación de Flyway y resolución de conflictos de puertos) para habilitar pruebas de usuario fiables. | Depurar el ambiente local y habilitar la recolección de métricas de uso real permite emitir juicios informados sobre la adopción técnica y viabilidad de las soluciones (Certificado Digital, Modo Offline), evaluando su impacto socioeconómico antes del despliegue final. |
|                                                                                                                                                              | Rodríguez Macedo, Sebastián      | TB2        | Apoyo en las secciones 8.3.4 To-Be Validation Interviews, 8.4 Experiment Aftermath & Analysis, 8.5 Continuous Learning y Conclusiones, utilizando los resultados de validación para analizar el reordenamiento del Question Backlog y los próximos aprendizajes del producto. | La participación permitió emitir juicios informados sobre el impacto de TextilFlow en la trazabilidad, la reducción de conflictos y la adopción operativa en contextos textiles reales, conectando la evidencia de entrevistas con decisiones futuras de mejora continua. |
| Awad Vargas, Giorgio Marzouk      | TB2        | Colaboración en la sección 8.3 Experimentation y en la preparación de la presentación final, sintetizando los hallazgos del proceso experimental y comunicando el impacto de las decisiones de diseño e implementación de TextilFlow ante el equipo y evaluadores. | La elaboración de la presentación final implicó emitir juicios informados sobre el valor generado por TextilFlow, considerando cómo la solución impacta en la eficiencia operativa, la reducción de pérdidas económicas y la transparencia comercial dentro del sector textil peruano. |
...
| :--- | :--- | :--- | :--- |
| **1. Salud Pública y Seguridad** | **Negativo:** Los operarios de almacén que usan la aplicación para el mapeo visual de fallas pueden sufrir fatiga visual o posturas inadecuadas si la interfaz exige periodos prolongados de atención a una pantalla pequeña en entornos industriales.<br><br>**Positivo:** Reduce el estrés laboral al digitalizar procesos manuales tediosos de auditoría, evitando pérdida de documentos en papel. | **Afectados:** Auditores de calidad y operarios en fábricas textiles (impacto físico leve/moderado por uso de dispositivos móviles). | **Acciones:** Implementar un diseño de interfaz de alto contraste e iconos grandes adaptado a entornos industriales. Sugerir pausas activas o dividir los flujos de auditoría de lotes grandes en pasos más cortos para evitar sobrecarga cognitiva. |
| **2. Inclusión y Accesibilidad** | **Negativo:** La plataforma requiere dispositivos móviles inteligentes y conexión a internet para operaciones en tiempo real, marginando a pequeños proveedores textiles en zonas con mala cobertura o sin presupuesto tecnológico.<br><br>**Positivo:** Estandariza la comunicación entre partes, superando barreras técnicas o de interpretación gracias a reportes visuales claros. | **Afectados:** Pequeños talleres o proveedores con recursos limitados. Trabajadores de mayor edad con baja alfabetización digital (impacto de exclusión tecnológica). | **Acciones:** Desarrollo del **"Modo Offline Simulado"** (US02) que permite a los proveedores trabajar sin conexión y sincronizar la información posteriormente. Diseño de interfaces sumamente intuitivas y soporte para lectores de pantalla. |
| **3. Impacto Social y Cultural** | **Negativo:** La digitalización del control de calidad puede generar fricción y resistencia al cambio en gremios textiles muy tradicionales que llevan décadas trabajando exclusivamente con hojas de papel.<br><br>**Positivo:** Fomenta una cultura de mayor transparencia, confianza y colaboración entre proveedores y empresarios al tener una fuente única de verdad. | **Afectados:** Cultura de trabajo de los operarios textiles tradicionales y la dinámica de confianza en la relación B2B (magnitud alta a nivel organizacional). | **Acciones:** Crear procesos de *onboarding* (capacitación) amigables que demuestren cómo la herramienta empodera y facilita el trabajo del operario en lugar de controlarlo o reemplazarlo. |
| **4. Impacto Económico** | **Negativo:** El modelo de negocio SaaS (suscripción) puede ser visto como un gasto adicional para microempresas que ya operan con márgenes muy bajos de ganancia.<br><br>**Positivo:** Optimiza recursos drásticamente, reduce la merma de telas no detectada a tiempo y evita disputas legales o rechazos injustificados, generando ahorros netos. | **Afectados:** Micro y pequeñas empresas textiles que conforman la cadena de suministro (impacto económico positivo a largo plazo, pero riesgo financiero inicial). | **Acciones:** Mantener niveles de suscripción escalonados, incluyendo un "Plan Freemium" (básico gratuito) o de muy bajo costo para pequeños proveedores. Garantizar que el ahorro generado por evitar fallas en telas justifique completamente la inversión. |
...
La implementación del pipeline de Continuous Deployment permitió automatizar el proceso de liberación del software hacia entornos de producción, reduciendo los tiempos de entrega y asegurando que cada versión desplegada cumpla con los estándares de calidad definidos por el equipo.

El establecimiento de un pipeline de Continuous Monitoring con herramientas como Prometheus y Grafana permitió recolectar, visualizar y alertar métricas en tiempo real de la aplicación TextilFlow, garantizando observabilidad operativa y capacidad de respuesta ante anomalías del sistema.

La realización de To-Be Validation Interviews y evaluaciones heurísticas permitió validar con usuarios reales si la solución propuesta era comprensible, útil y usable, asegurando que las decisiones de diseño e implementación estuvieran fundamentadas en evidencia directa de los segmentos objetivo.

El análisis posterior a los experimentos (Experiment Aftermath & Analysis) permitió interpretar los resultados obtenidos, re-priorizar el Question Backlog y extraer aprendizajes concretos sobre el comportamiento de los usuarios frente a las funcionalidades de TextilFlow, consolidando un ciclo de mejora continua basado en datos.

La práctica de Continuous Learning, materializada en las sesiones de Shareback, permitió al equipo sistematizar los aprendizajes obtenidos durante la experimentación y compartirlos de forma estructurada, fortaleciendo la capacidad colectiva de tomar decisiones más informadas en futuras iteraciones del producto.
